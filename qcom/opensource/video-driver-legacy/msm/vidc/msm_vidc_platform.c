...
static const struct of_device_id msm_vidc_dt_match[] = {
	...
	{
		.compatible = "qcom,msm-vidc-khaje",
		.data = &bengal_data,
	},
	{
		.compatible = "qcom,msm-vidc-ar50lt",
		.data = &bengal_data,
	},
	{
...
void *vidc_get_drv_data(struct device *dev)
{
	...
	if (!strcmp(match->compatible, "qcom,sdm670-vidc")) {
		...
		driver_data->max_inst_count = MAX_SUPPORTED_INSTANCES_24;
		   ...
		   !strcmp(match->compatible, "qcom,msm-vidc-khaje") ||
		   !strcmp(match->compatible, "qcom,msm-vidc-ar50lt") ||
		   !strcmp(match->compatible, "qcom,msm-vidc")) {
