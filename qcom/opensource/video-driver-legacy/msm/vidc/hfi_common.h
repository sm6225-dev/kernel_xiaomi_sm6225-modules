...
#define venus_hfi_for_each_thing(__device, __thing, __thingy) \
	for (__thing = ((__device) && (__device)->res && (__device)->res->__thingy##_set.count) ? \
			&(__device)->res->__thingy##_set.__thingy##_tbl[0] : NULL; \
		__thing && (__thing < &(__device)->res->__thingy##_set.__thingy##_tbl[0] + \
			(__device)->res->__thingy##_set.count); \
		++__thing)

#define venus_hfi_for_each_thing_reverse(__device, __thing, __thingy) \
	for (__thing = ((__device) && (__device)->res && (__device)->res->__thingy##_set.count) ? \
			&(__device)->res->__thingy##_set.__thingy##_tbl[(__device)->res->__thingy##_set.count - 1] : NULL; \
		__thing && (__thing >= &(__device)->res->__thingy##_set.__thingy##_tbl[0]); \
		--__thing)

#define venus_hfi_for_each_thing_continue(__device, __thing, __thingy, __from) \
	for (__thing = ((__device) && (__device)->res && (__device)->res->__thingy##_set.count && (__from) < (__device)->res->__thingy##_set.count) ? \
			&(__device)->res->__thingy##_set.__thingy##_tbl[__from] : NULL; \
		__thing && (__thing < &(__device)->res->__thingy##_set.__thingy##_tbl[0] + \
			(__device)->res->__thingy##_set.count); \
		++__thing)
...
#define venus_hfi_for_each_thing_reverse_continue(__device, __thing, __thingy, \
		__from) \
	for (__thing = ((__device) && (__device)->res && (__device)->res->__thingy##_set.count && (__from) >= 0) ? \
			&(__device)->res->__thingy##_set.__thingy##_tbl[min_t(int, (__from), (__device)->res->__thingy##_set.count - 1)] : NULL; \
		__thing && (__thing >= &(__device)->res->__thingy##_set.__thingy##_tbl[0]); \
		--__thing)
