...
#include "bengal-dailink-defs.h"

#define DRV_NAME "bengal-asoc-snd"

static int aw87xxx_spk_mode_val;
static int aw87xxx_rcv_mode_val;

static struct snd_soc_component *
msm_soc_find_component_by_node(struct device_node *of_node)
{
	...
	if (pdev) {
		comp = snd_soc_lookup_component(&pdev->dev, NULL);
		put_device(&pdev->dev);
	}
	return comp;
}
...
static void msm_mi2s_snd_shutdown(struct snd_pcm_substream *substream)
{
	int ret = 0;
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	int index = asoc_rtd_to_cpu(rtd, 0)->id;
	struct snd_soc_card *card = rtd->card;
	struct msm_asoc_mach_data *pdata = snd_soc_card_get_drvdata(card);
...
static int msm_int_audrx_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	{
		if (msm_aux_dev[i].dlc.name != NULL ) {
			if (strstr(msm_aux_dev[i].dlc.name, "wsa"))
				continue;
		}

		if (msm_aux_dev[i].dlc.of_node) {
...
static void * __maybe_unused def_wcd_mbhc_cal(void)
{
	void *wcd_mbhc_cal;
...
static void * __maybe_unused def_rouleur_mbhc_cal(void)
{
	void *wcd_mbhc_cal;
	struct wcd_mbhc_btn_detect_cfg *btn_cfg;
	u16 *btn_high;
...
static struct snd_soc_dai_link msm_common_dai_links[] = {
	...
	{/* hw:x,5 */
		...
		/* this dainlink has playback support */
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_241),
	},
	{/* hw:x,6 */
		.name = "MSM AFE-PCM TX",
		...
		.dpcm_capture = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_240),
	},
	{/* hw:x,7 */
	...
	{/* hw:x,14 */
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(hdmi_hostless),
	},
	{/* hw:x,15 */
		.name = "VoiceMMode2",
	...
	{/* hw:x,30 */
		...
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(cdc_dma_hostless),
	},
	{/* hw:x,31 */
		...
		.trigger = {SND_SOC_DPCM_TRIGGER_POST,
			    SND_SOC_DPCM_TRIGGER_POST},
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(tx3_cdc_dma_hostless),
	},
	{/* hw:x,32 */
...
static struct snd_soc_dai_link msm_common_misc_fe_dai_links[] = {
	...
	{/* hw:x,38 */
		...
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45115),
	},
	...
	{/* hw:x,39 */
		...
		.ignore_suspend = 1,
		 /* this dailink has playback support */
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(cdc_dma_2_hostless),
	},
...
static struct snd_soc_dai_link msm_common_be_dai_links[] = {
	/* Backend AFE DAI Links */
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_224),
	},
	{
		...
		.be_hw_params_fixup = msm_be_hw_params_fixup,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_225),
	},
	/* Incall Record Uplink BACK END DAI Link */
	{
		...
		.be_hw_params_fixup = msm_be_hw_params_fixup,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_32772),
	},
	/* Incall Record Downlink BACK END DAI Link */
	{
		...
		.be_hw_params_fixup = msm_be_hw_params_fixup,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_32771),
	},
	/* Incall Music BACK END DAI Link */
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_32773),
	},
	/* Incall Music 2 BACK END DAI Link */
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_32770),
	},
	/* Proxy Tx BACK END DAI Link */
	{
		...
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_8195),
	},
	/* Proxy Rx BACK END DAI Link */
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_8194),
	},
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_28672),
	},
	{
		...
		.be_hw_params_fixup = msm_be_hw_params_fixup,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_28673),
	},
};
...
static struct snd_soc_dai_link msm_tdm_be_dai_links[] = {
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36864),
	},
	{
		...
		.ops = &bengal_tdm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36865),
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36880),
	},
	{
		...
		.ops = &bengal_tdm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36881),
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36896),
	},
	{
		...
		.ops = &bengal_tdm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36897),
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36912),
	},
	{
		...
		.ops = &bengal_tdm_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_tdm_36913),
	},
};
...
static struct snd_soc_dai_link msm_wcn_btfm_be_dai_links[] = {
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_16398),
	},
	{
		...
		.ops = &msm_wcn_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_16399),
	},
	{
		...
		.ops = &msm_wcn_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_16401),
	},
};
...
static struct snd_soc_dai_link msm_mi2s_be_dai_links[] = {
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_0),
	},
	{
		...
		.ops = &msm_mi2s_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_0_1),
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_1),
	},
	{
		...
		.ops = &msm_mi2s_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_1_1),
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_2),
	},
	{
		...
		.ops = &msm_mi2s_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_2_1),
	},
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_mi2s_3),
	},
	{
...
static struct snd_soc_dai_link msm_auxpcm_be_dai_links[] = {
	/* Primary AUX PCM Backend DAI Links */
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_1),
	},
	{
		...
		.ops = &bengal_aux_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_1_1),
	},
	/* Secondary AUX PCM Backend DAI Links */
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_2),
	},
	{
		...
		.ops = &bengal_aux_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_2_1),
	},
	/* Tertiary AUX PCM Backend DAI Links */
	{
		...
		.ops = &bengal_aux_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_3),
	},
	{
		...
		.ops = &bengal_aux_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_3_1),
	},
	/* Quaternary AUX PCM Backend DAI Links */
	{
		...
		.ops = &bengal_aux_be_ops,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_auxpcm_4),
	},
	{
...
static struct snd_soc_dai_link msm_rx_tx_cdc_dma_be_dai_links[] = {
	/* RX CDC DMA Backend DAI Links */
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45104),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45106),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45108),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45110),
	},
	/* TX CDC DMA Backend DAI Links */
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45111),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45113),
	},
};
...
static struct snd_soc_dai_link msm_va_cdc_dma_be_dai_links[] = {
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45089),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45091),
	},
	{
		...
		.ignore_suspend = 1,
		.ops = &msm_cdc_dma_be_ops,
		SND_SOC_DAILINK_REG(msm_dai_cdc_dma_dev_45093),
	},
};
...
static struct snd_soc_dai_link msm_afe_rxtx_lb_be_dai_link[] = {
	{
		...
		.ignore_pmdown_time = 1,
		.ignore_suspend = 1,
		SND_SOC_DAILINK_REG(msm_dai_q6_dev_24577),
	},
};
					...
					struct snd_soc_card *card)
{
	...
	cpus = devm_kcalloc(cdev, card->num_links, sizeof(*cpus), GFP_KERNEL);
	codecs = devm_kcalloc(cdev, card->num_links, sizeof(*codecs), GFP_KERNEL);
	platforms = devm_kcalloc(cdev, card->num_links, sizeof(*platforms), GFP_KERNEL);

	if (!cpus || !codecs || !platforms)
		return -ENOMEM;

	for (i = 0; i < card->num_links; i++) {
		cpus[i] = *dai_link[i].cpus;
		codecs[i] = *dai_link[i].codecs;
		platforms[i] = *dai_link[i].platforms;

		dai_link[i].cpus = &cpus[i];
		dai_link[i].codecs = &codecs[i];
		dai_link[i].platforms = &platforms[i];
...
static int msm_snd_card_bengal_late_probe(struct snd_soc_card *card)
{
	...
	ret = snd_soc_dapm_add_routes(&card->dapm, bengal_legacy_dapm_routes,
				      ARRAY_SIZE(bengal_legacy_dapm_routes));
	if (ret)
		dev_warn(card->dev, "%s: failed to add legacy dapm routes: %d\n",
			 __func__, ret);
	else
		dev_info(card->dev, "%s: added legacy dapm routes successfully\n",
			 __func__);
				...
				struct snd_soc_card *card)
{
	...
	for (i = 0; i < wsa_dev_cnt; i++) {
		...
		if (msm_soc_find_component_by_node(wsa_of_node)) {
...
codec_aux_dev:
	...
	for (i = 0; i < codec_aux_dev_cnt; i++) {
		...
		if (msm_soc_find_component_by_node(aux_codec_of_node)) {
...
aux_dev_register:
	...
	for (i = 0; i < wsa_max_devs; i++) {
		...
		msm_codec_conf[i].dlc.name = NULL;
		msm_codec_conf[i].name_prefix = auxdev_name_prefix[0];
		msm_codec_conf[i].dlc.of_node =
				wsa881x_dev_info[i].of_node;
	}
	...
	for (i = 0; i < codec_aux_dev_cnt; i++) {
		...
		msm_codec_conf[wsa_max_devs + i].dlc.name = NULL;
		msm_codec_conf[wsa_max_devs + i].name_prefix =
						NULL;
		msm_codec_conf[wsa_max_devs + i].dlc.of_node =
				aux_cdc_dev_info[i].of_node;
	}
...
#ifdef CONFIG_SND_SOC_AW87XXX
	aw87xxx_spk_mode_val = 0;
	aw87xxx_rcv_mode_val = 0;
	pcard = card;
#endif /* CONFIG_SND_SOC_AW87XXX */
